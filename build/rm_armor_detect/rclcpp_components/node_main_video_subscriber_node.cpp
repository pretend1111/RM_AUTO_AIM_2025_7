...
#define NODE_MAIN_LOGGER_NAME "video_subscriber_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libvideo_subscriber_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_armor_detect::VideoSubscriberNode>";
