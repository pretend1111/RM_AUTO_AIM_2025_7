...
#define NODE_MAIN_LOGGER_NAME "mechax_trajectory_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmechax_trajectory.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<rm_trajectory::Trajectoryer>";
